...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	const FOOTER_NAV_MENU_ONE_SLUG  = 'footer_menu_one';
	const FOOTER_NAV_MENU_TWO_SLUG  = 'footer_menu_two';
	...
	public function template_tags() : array {
		return array(
			...
			'is_footer_nav_menu_one_active' => array( $this, 'is_footer_nav_menu_one_active' ),
			'display_footer_nav_menu_one'   => array( $this, 'display_footer_nav_menu_one' ),
			'is_footer_nav_menu_two_active' => array( $this, 'is_footer_nav_menu_two_active' ),
			'display_footer_nav_menu_two'   => array( $this, 'display_footer_nav_menu_two' ),
		);
	}
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				...
				static::FOOTER_NAV_MENU_ONE_SLUG  => esc_html__( 'Footer Menu One', 'wp-rig' ),
				static::FOOTER_NAV_MENU_TWO_SLUG  => esc_html__( 'Footer Menu Two', 'wp-rig' ),
			)
		);
	}
	...
	/**
	 * Checks whether the footer menu one menu is active.
	 *
	 * @return bool True if the footer menu one is active, false otherwise.
	 */
	public function is_footer_nav_menu_one_active() : bool {
		return (bool) has_nav_menu( static::FOOTER_NAV_MENU_ONE_SLUG );
	}

	/**
	 * Displays the footer menu one.
	 *
	 * @param array $args Optional. Array of arguments. See `wp_nav_menu()` documentation for a list of supported
	 *                    arguments.
	 */
	public function display_footer_nav_menu_one( array $args = array() ) {
		if ( ! isset( $args['container'] ) ) {
			$args['container']  = 'ul';
		}

		$args['theme_location'] = static::FOOTER_NAV_MENU_ONE_SLUG;

		wp_nav_menu( $args );
	}

	/**
	 * Checks whether the footer menu two menu is active.
	 *
	 * @return bool True if the footer menu two is active, false otherwise.
	 */
	public function is_footer_nav_menu_two_active() : bool {
		return (bool) has_nav_menu( static::FOOTER_NAV_MENU_TWO_SLUG );
	}

	/**
	 * Displays the footer menu two.
	 *
	 * @param array $args Optional. Array of arguments. See `wp_nav_menu()` documentation for a list of supported
	 *                    arguments.
	 */
	public function display_footer_nav_menu_two( array $args = array() ) {
		if ( ! isset( $args['container'] ) ) {
			$args['container'] = 'ul';
		}

		$args['theme_location'] = static::FOOTER_NAV_MENU_TWO_SLUG;
