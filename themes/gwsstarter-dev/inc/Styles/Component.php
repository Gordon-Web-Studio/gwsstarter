...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	protected function get_css_files() : array {
		...
		$css_files = array(
			...
			'wp-main-layout' => array(
				'file'   => 'layouts/layout-main.min.css',
				'global' => true,
			),
			'wp-content'     => array(
	...
	/**
	 * Returns the Typekit URL to use for enqueuing Typekit Fonts CSS.
	 *
	 * @return string Typekit Fonts URL, or empty string if no Typekit Fonts should be used.
	 */
