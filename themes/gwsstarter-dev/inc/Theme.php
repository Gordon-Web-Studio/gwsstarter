...
class Theme {
	...
	protected function get_default_components() : array {
		$components = array(
			...
			new Custom_Logo_Alternative\Component(),
			new Custom_Topbar\Component(),
			...
			new Core_Block\Component(),
			new Custom_Theme_Settings\Component(),
			new Custom_Block_Category\Component(),
			new Custom_Block\Component(),
			new Custom_Block_Pattern\Component(),
			new Custom_Block_Template\Component(),
			/* new Disable_Editors\Component(), */
